...
def part4(data, W0, b0, y):
    ...
    alpha = 0.0001
    final_weights = grad_descent(df, data, y, W0, b0, alpha)
...
if __name__ == "__main__":
    ...
    part4(trainX, weights, weights_bias, trainY)
